      ...
      <section className="py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {[
              { icon: 'stethoscope', title: 'Profesionales de Salud', desc: 'Médicos, enfermeras y terapeutas que desean integrar herramientas de cuidado espiritual en su práctica clínica diaria.' },
              { icon: 'diversity_3', title: 'Consejeros Espirituales', desc: 'Líderes religiosos que buscan profesionalizar su vocación mediante estándares clínicos rigurosos.' },
              { icon: 'volunteer_activism', title: 'Cuidadores', desc: 'Personas dedicadas al cuidado paliativo o de largo plazo, buscando resiliencia y técnicas de cuidado espiritual.' },
            ].map((item, idx) => (
              <div key={idx} className="bg-white dark:bg-surface-dark p-8 rounded-lg shadow-sm border border-gray-100 dark:border-gray-800 hover:shadow-md transition-shadow w-full md:w-[calc(50%-12px)] lg:w-[300px]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { icon: 'favorite', title: 'Atención Centrada en la Persona', desc: 'Enfoque terapéutico centrado en la persona, priorizando sus valores y necesidades únicas.' }
            ].map((comp, i) => (
