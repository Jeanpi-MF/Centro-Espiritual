            ...
            <section className="relative bg-primary py-24 lg:py-32 overflow-hidden text-white">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <p className="text-xl text-gray-300 max-w-3xl font-light leading-relaxed mb-10">
                        El estándar de oro en la formación de consejeros y cuidadores espirituales profesionales. Un proceso transformador de aprendizaje basado en la experiencia práctica y la reflexión teológica profunda.
                    </p>
                    <button
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-display font-bold text-primary dark:text-white mb-6">
                                Formación Clínica: De la práctica a la excelencia
                            </h2>
                            <p className="text-gray-600 dark:text-gray-400 text-lg leading-relaxed mb-6 font-light">
                                Nuestro modelo andragógico se basa en la metodología clínica de Acción - Reflexión - Acción. Buscamos que cada participante desarrolle una "presencia no ansiosa" y una identidad profesional clara. Experiencia en campo: 300 horas de práctica directa con pacientes y familias en su entorno de trabajo. Supervisión Especializada: 100 horas de reflexión individual y grupal para procesar el impacto emocional y espiritual del cuidado. Desarrollo Integral: El resultado es un profesional capaz de evaluar, intervenir y acompañar con los más altos estándares de calidad.                            </p>
                            <ul className="space-y-4">
                                {[
                                    'Práctica clínica supervisada.',
                                    'Mentoría grupal semana.',
